...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Im \textit{build.gradle} File Dependency hinzufügen
\begin{lstlisting}
dependencies {
...
\end{lstlisting}
	...
	\begin{table}[h!]
		...
		\begin{tabularx}{\linewidth}{l X}
			...
			Interface & Nutzen \\
			\midrule
			GVSTreeWithRoot & Erstellt einen Tree anhand der Root Node und den Kind Beziehungen \\
			GVSTreeWithCollection & Erstellt einen Tree anhand der Root Node und den Kind Beziehungen. Die Collection muss manuell gefüllt werden.  \\
