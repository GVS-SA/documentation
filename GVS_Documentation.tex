...
\begin{document}
	...
	Während der Verwendung von GVS 1.0 wurden verschiedenste Dinge bemerkt, die nicht optimal funktionieren. Diese wurden vom Betreuer in einer Liste festgehalten und an das Projektteam überreicht. Gemäss einer Besprechung wurden diese Änderungen mit tiefer Priorität in den Backlog eingepflegt (siehe Anhang \ref{ch:minutes}). Dieses Kapitel zeigt auf, welche Punkte bis zum Abschluss des Projekts offen geblieben sind.
	...
	GVS 3.0 sollte das verwendete Protokoll und die GVS Lib Klassen so anpassen, dass solche Notizen direkt im Client erstellt und mit den Graphen mitgeschickt werden können.
