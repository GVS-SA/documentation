...
\begin{document}
	...
	\includepdf{assets/pdf/gvs-lib.pdf}
	...
	\begin{enumerate}
		\item Klassendiagramm Analyse
		\item Klassendiagramm Entwurf
		\item Klassendiagramm Realisierung
	\end{enumerate}
	
	\includepdf[fitpaper]{assets/pdf/gvs1-0.pdf}
	\includepdf[fitpaper]{assets/pdf/gvs2-1.pdf}
	\includepdf[fitpaper]{assets/pdf/classdiagramm-ui-A3.pdf}
