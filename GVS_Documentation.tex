...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{tabularx}{\linewidth}{X X X X}
			...
			Datum & Version & Änderungen & Autor \\
			\midrule
			25.09.17 & 1.0 & Dokument erstellt & wie, tre \\
			28.09.17 & 1.1 & Risikomanagement hinzugefügt & tre \\
			\bottomrule 
		\end{tabularx} 
	...
	\begin{landscape}		
		\subsection{Mögliche Risiken}
			...
			\begin{tabularx}{\linewidth}{l X l l X X}
				...
				\midrule
				2 & Komplexität wurde unterschätzt. Der effektive Zeitaufwand übersteigt die Schätzung um ein Vielfaches & 2 & 2 & Gute Recherche und Einarbeit in GVS 1.0, genügend lange Inception Phase & Rücksprache mit Betreuer \\
				\midrule
				3 & Funktionalitäten von GVS 1.0, welche mit Swing umgeseztzt wurden, werden durch JavaFX nicht oder unzureichend unterstützt & 2 & 2 & Einlesen in JavaFX, Funktionalitäten GVS 1.0 abklären & Alternative zur bestehenden Umsetzung finden \\
				\bottomrule 
			\end{tabularx} 
