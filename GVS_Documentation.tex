...
\begin{document}
	...
	\subsubsection{Verbindungsaufbau}
	Abbildung \ref{fig:sd-verbindungsaufbau-2} zeigt den Start der GVS 2.0 Applikation über die \textit{GVSApplication} sowie das Empfangen von Daten über die Socket. Änderungen gegenüber GVS 1.0 finden sich in folgender Liste:
	\begin{description}
		\item[\gls{di}] \hfill \\
		GVS 2.0 setzt an vielen Orten auf \gls{di} (siehe \ref{DI})
	\end{description}
