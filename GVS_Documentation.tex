...
\begin{document}
	...
	%TODO keine Vergangenheiten, keine beschreibungen was gemacht wurde, sondern was gemacht werden muss.
	
	%TODO check anleitung dokumentation ba_sa -> identifikation
	
	%TODO Handbuch und Installationsanleitung. Mü weiss mehr :)
	...
	%TODO die anforderungsspezifikation muss facts enthalten
	%TODO was der kunde/auftraggeber will.
	%TODO nicht in der verhangenheit schreiben
	%TODO was sind die anforderunge!
	%TODO das klassendiagramm 1.0 gibt eine übersicht über die struktur.. bla bla
	...
	%TODO verweis auf doku 1.0. quellenverzeichnis
	Die funktionalen Anforderungen werden vollständig von GVS 1.0 übernommen. Der Funktionsumfang der Applikation soll nicht verändert werden.
	
	\subsection{Nicht funktionale Anforderungen}
	
	\subsubsection{Usability}
	Die Applikation muss intuitiv verwendbar sein. Die Benutzbarkeit soll von Studenten überprüft werden, die nicht im Projektteam sind.
	
	\subsubsection{Verständlichkeit}
	%TODO Link Installationsanleitung
	Ein Benutzer muss bei der erstmaligen Verwendung von GVS 2.0 die Software innerhalb von 15 Minuten in Betrieb nehmen können. Die Installationsanleitung soll eine entsprechende Unterstützung bieten.
	
	\subsubsection{Performance}
	Die Software muss einen Datenstruktur innerhalb von 2 Sekunden darstellen. 	
	...
	%TODO GVS 1.0 hat die schichten zwar angedacht. Wiederspiegelt sich aber nicht in dem package design.
	%TODO zeigt die alten klassen zugeteilt auf die entsprechenden layer
	%TODO in diesem klassendiagramm ist die zuteilung auf die schichten dargestellt.
	%TODO die schichten waren in den packages nicht genau abgebildet!
	%TODO die zuteilung wurden vom projektteam gemacht!
	
	Das Klassendiagramm gibt eine Übersicht über die wichtigsten Klassen von GVS 1.0. Im vorhergehenden Projekt wurden die Schichten zwar angedacht, sie widerspiegeln sich aber kaum im Package Design. Um den Überblick zu verbessern, sollen die Klassen den entsprechenden Schichten zugewiesen werden. Dies erhöht die Verständlichkeit der Problemdomäne und vereinfacht den Übergang in die neue Schichtenarchitektur. Eine genaue Analyse der GVS 1.0 Klassen ist dem Abschnitt \ref{sec:erkenntnisse} zu entnehmen. 
	
	\includepdf[fitpaper]{assets/pdf/gvs1-0.pdf}
		
	\subsection{Sequenzdiagramme}
	Die Sequenzdiagramme zeigen die wichtigsten Systemabläufe des GVS 1.0. 
	...
	%TODO angedachte Architektur aus GVS 1.0
	...
	\subsection{Schlüsse}
	%TODO verschieben ins design
	%TODO in den Projektplan: Refactoring wird vordlaufend gemacht.
	...
	\section{Frameworks}
	%TODO Verschieben in Anforderungsspezifikation
