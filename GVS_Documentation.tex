...
\begin{document}
	...
	\begin{enumerate}
		\item Im der \gls{gvsui} Komponente muss das Framework Swing durch den offiziellen Nachfolger \gls{javafx} ersetzt werden.
		\item In der \gls{gvslib} Komponenteeil muss die Java und .NET Library um Generics erweitert werden. 
