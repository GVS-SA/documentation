...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{tabularx}{\linewidth}{X X }
			...
			Graph Vertices lassen sich ausserhalb des sichtbaren Programmfenster draggen & ZoomPane skalliert das Fenster, sobald ein Knoten den Viewport verlässt \\
