...
\begin{document}
	...
	GVS ist eine Visualisierungs-Software die Graphen und Trees darstellt. Durch die Verwendung von Styles können auch Algorithmen auf den Graphen visualisiert werden.\\
	...
	In der Studienarbeit wurde ein vollumfänglicher Ersatz für den GVS 1.0 entwickelt.\\
	...
	\subsection*{Ausblick}
	Das Projektteam ist vom praktischen Nutzen der Applikation überzeugt und wird sich deshalb in der Bachelorarbeit mit einer umfänglicheren Anwendung beschäftigen. Diese wird den Studenten das Erlernen von weiteren theoretischen Informatikkonzepten durch Visualisierung erleichtern.  
