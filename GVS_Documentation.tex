...
\begin{document}
	...
	\begin{itemize}
		...
		\item EclEmma \cite{eclemma} zur Überprüfung der Test Coverage
		\item Stan4J \cite{stan4j} zur Überprüfung von zyklischen Abhängigkeiten
		\item Checkstyle \cite{checkstyle} zur Überprüfung der Coding Guidelines.
	\end{itemize}

	\section{ [ Frameworks ] }
	%TODO any additional libraries? 
	Als UI Framework wird \gls{javafx} eingesetzt. \gls{javafx} gilt seit 2014 als Standardlösung für grafische Java Anwendungen. \gls{javafx} ist eine komplette Neuentwicklung und ist der offizielle Nachfolger von AWT und Swing. 
	...
	\subsection{TDD}
	Zur Sicherung der Software Qualität sind gute Tests unerlässlich. Es macht deshalb Sinn für jedes Feature zuerst entsprechende Tests zu schreiben. \gls{tdd} verfolgt genau diesen Ansatz und soll in dem Projekt speziell im Business Layer verwendet werden. 
