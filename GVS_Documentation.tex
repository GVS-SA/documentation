...
\begin{document}
	...
	\noindent Während dem Projekt konnten eine erweiterbare Software Architektur erstellt werden, die das Vorgängerprodukt vollumfänglich ersetzt. Zusätzlich wurde das Usability verbessert und durch den Einsatz von speziellen Layouting Algorithmen eine ansprechende Darstellung von ''Graphen'' und ''Trees'' erreicht.
	...
	GVS ist eine Visualisierungs-Software die Graphen und Trees ansprechend darstellt. Die Datenstrukturen werden in der Entwicklungsumgebung des Benutzers programmiert und mit einer clientseitingen Library an die Visualisierungskomponenten übertragen. Die Server Komponenten interpriert die eingehenden Daten und stellt diese auf eine ansprechende Art und Weise dar. \\
