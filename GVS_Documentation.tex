	...
	\begin{landscape}		
		\subsection{Mögliche Risiken}
			...
			\begin{tabularx}{\linewidth}{l X l l X X}
				...
				\midrule
				2 & Der Visualization Layer hat wesentlich mehr Abhängigkeiten als angenommen. Der nötige Zeitaufwand übersteigt die Schätzung um ein Vielfaches & 2 & 2 & Gute Recherche und Einarbeit in GVS 1.0, genügend lange Inception Phase & Rücksprache mit Betreuer: Allenfalls Ausweitung der geplanten Refactorings auf weitere Komponenten \\
				\midrule
