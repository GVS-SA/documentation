...
\begin{document}
	...
	\begin{tabularx}{\linewidth}{l l X l}
		...
		08.12.17 & 1.3 & Klassendiagramm GVS 2.0 & mtrentini \\
		\bottomrule 
	\end{tabularx} 
	...
	\begin{description} \label{desc:architecture-changes}
		\item[GvsXmlReader \& ClientConnection ] \hfill \\ Diese Klassen entstanden durch ein Refactoring der GVS 1.0 Klasse \textit{ServerConnectionXML}. Die Trennung dieser Klasse führt dazu, dass das \textit{Single Responsibility Principle} eingehalten wird. 
		...
		\item[TreeVertex \& LeafVertex] \hfill \\ Zum Zeitpunkt der Entwurfsphase war nicht nicht klar, wo genau die Trennung zwischen Trees und Graphen stattfindet. Schlussendlich findet im Business Layer eine Unterscheidung für Vertices und Layouter statt (siehe \ref{ssec:graphs-and-trees}). Die Entwicklung des TreeLayouters hat gezeigt, dass neben normalen Tree Vertices auch Blatt-Knoten nötig sind (siehe \ref{ssec:tree-layouter}).
	...
	\subsection{Tree Layout Algorithmus} \label{ssec:tree-layouter}
