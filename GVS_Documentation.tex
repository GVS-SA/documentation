...
\begin{document}
	...
	Die nebenläufigen Klassen werden von speziellen Synchronisationspunkten serialisiert, die in Tabelle \ref{tbl:sync-pt} aufgelistet sind. Alle Klassen werden von Guice \cite{guice} als Singleton instantiiert. Dies ist wichtig, da sich die Threads andernfalls auf unterschiedliche Objekte beziehen. Die Synchronisation würde in diesem Fall nicht greifen.
