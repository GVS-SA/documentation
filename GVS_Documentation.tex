...
\begin{document}
	...
	\paragraph{Model}
	Das Model enthält reine Datenklassen ohne nennenswerte Logik.
	
	\paragraph{View}
	Die View stellt den UI Zustand des View Model dar. Sie setzt sich aus einer Controller Klasse sowie einer deklarativen \gls{fxml} Datei zusammen. Auch die View beinhaltet keine nennenswerte Logik. Sie leitet die eingehenden Request direkt an das View Model weiter. Mit der Databinding-API wird eine bidirektionale Kommunikation zwischen View und View Model sichergestellt. 
	...
	Der Access Layer enthält Klassen für den Zugang zum Socket Server, sowie dem Filesystem. Ist für das Parsen von eingehenden XML Files zuständig und für deren Umwandlung in Domainobjekte.
