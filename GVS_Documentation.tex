...
\begin{document}
	...
	\noindent Diese Studienarbeit beschäftigt sich mit der Erneuerung des gesamten GVS 1.0, wobei insbesondere bei der Server Komponente das UI Framework ersetzt wird. In einer Analysephase wurde der bestehende Code auf Verbesserungspotential untersucht. Die gewonnen Erkenntnisse fliessen in eine saubere Schichtenarchitektur ein, die es auch Folgearbeiten erleichtern soll, einzelne Schichten zu ersetzen. \\
