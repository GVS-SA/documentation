...
\begin{document}
	...
	%TODO Handbuch und Installationsanleitung. Kürzel in Fusszeile
	...
	%TODO was sind die anforderungen!
	...
	Das Klassendiagramm gibt eine Übersicht über die wichtigsten Klassen von GVS 1.0. Im vorhergehenden Projekt wurden die Schichten zwar angedacht, sie widerspiegeln sich aber kaum im Package Design. Um den Überblick zu verbessern, sind die Klassen den entsprechenden Schichten zugewiesen. Dies erhöht die Verständlichkeit der Problemdomäne und vereinfacht den Übergang in die neue Schichtenarchitektur. Eine genaue Analyse der GVS 1.0 Klassen ist dem Abschnitt \ref{sec:erkenntnisse} zu entnehmen. 
	...
	\paragraph{Layering}
	In GVS 1.0 wurde eine Schichtenarchitektur angedacht, sie widerspiegelt sich aber kaum im Package Design. Gut erkennbar ist die Trennung des Access Layers (Socket Server) zur restlichen Applikation. GUI spezifische Elemente ziehen sich durch mehrere Layer.
	
	\paragraph{Swing/AWT Imports im Business Layer} 
	...
	\paragraph{Tangles} Zwischen dem Presentation und Business Layer existieren \gls{tangle}s. Dies verhindert einen einfachen Austausch des Presentation Layers. 
	
	\paragraph{Magic Numbers} Viele Konstanten wurden ungenügend beschrieben. Der Zweck von vielen Zahlen ist daher nur schwer nachvollziehbar.
	
	\paragraph{Namenskonvention}
	...
	\paragraph{Keine Unit Tests} Im Projekt wurden keine Unit Tests geschrieben. Der Grund dafür ist vermutlich, dass JUnit zum Entwicklungszeitpunkt noch sehr jung war.
