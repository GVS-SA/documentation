...
\begin{document}
	...
	\noindent Während dem Projekt konnten eine erweiterbare Software Architektur erstellt werden, die das Vorgängerprodukt vollständig ersetzt. Wie eingesetzte Metriken zeigen, konnte die Code-Qualität beträchtlich gesteigert werden. Zusätzlich wurde die Usability verbessert und durch den Einsatz von speziellen Layouting Algorithmen eine ansprechende Darstellung von \textit{Graphen} und \textit{Trees} erreicht.
