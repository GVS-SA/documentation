...
\newglossaryentry{isomorph}
{
	name={isomorph},
	description={von gleicher Gestalt oder Struktur},
	first={isomorph}
}
...
{
	name={FXML},
	description={JavaFX XML: XML basierte UI Markup Language für JavaFX Programme. },
...
{
	name={GoF},
	description={Gang of Four: Sammlung an wiederverwendbaren Software Pattern von Erich Gamma, Richard Helm, Ralph Johnson und John Vlissides},
